...
def drop_tables(cur, conn):
    """
        This function will iterate over all the drop table queries and executes them.
        INPUTS:
...
def create_tables(cur, conn):
    ...
    """
        This function  will iterate over all the create table queries and executes them.
        INPUTS:
        * cur: the cursor variable of the database
        * conn: the connection variable of the database
    """
